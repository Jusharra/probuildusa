...
const ServicePage: React.FC = () => {
  ...
  const serviceData = {
    ...
    'estimation-bidding': {
      ...
      subtitle: 'Specializing in Drywall — Professional Take-Offs, Bid Packages & Cost Estimation',
      priceRange: 'Custom / Project-Based',
      timeline: '3–5 business days',
      description: 'Accurate drywall estimates win projects and protect margins. We specialize in commercial drywall quantity take-offs, bid package preparation, and detailed cost estimation — delivering CSI-formatted numbers in 3–5 days so your crews can bid faster and smarter. We also cover full commercial and industrial estimation across all trades.',
      heroImage: 'https://images.pexels.com/photos/669619/pexels-photo-669619.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
      included: [
        'Drywall quantity take-offs (board, framing, finish)',
        'Light-gauge steel framing estimates',
        'Insulation and sheathing breakdowns',
        'Taping, mudding & texture scope',
        'Commercial drywall bid package assembly',
        'Multi-trade quantity take-offs',
        'CSI division organization (all trades)',
        'Conceptual and schematic-level estimates',
        'Cost comparison and value engineering',
        'Bid leveling, analysis & final summary',
      ],
      idealFor: [
        'Drywall subcontractors bidding commercial jobs',
        'General contractors managing drywall scopes',
        'Developers planning office, retail, or multifamily builds',
        'Property owners seeking independent cost validation',
        'Project managers overseeing multi-trade interior scopes',
      ],
      process: [
        'Upload plans and project scope documents',
        'Drywall estimator assigned within 24 hours',
        'Full quantity take-off and material pricing',
        'Draft estimate reviewed for accuracy',
        'Final CSI-formatted deliverable sent in 3–5 days',
        'Free revision included for scope changes',
      ],
      gallery: [
    ...
    'scheduling': {
      ...
      subtitle: 'Master Schedules, Milestone Tracking & Timeline Management',
      priceRange: 'Project-Based',
      timeline: '2–5 business days',
      description: 'Delays are the #1 cost driver on construction projects. We build and manage master schedules — CPM, Gantt, and lookahead formats — that keep your team aligned, your subs accountable, and your project on time. Whether you need a schedule built from scratch or a recovery plan for a troubled project, we deliver.',
      heroImage: 'https://images.pexels.com/photos/3243090/pexels-photo-3243090.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
      included: [
        'Master schedule development (CPM / Gantt)',
        '3-week and 6-week lookahead schedules',
        ...
        'Project closeout schedule management',
      ],
      idealFor: [
        'General contractors managing multi-trade projects',
        'Project owners who need schedule oversight',
        'Developers tracking construction timelines',
        'Facility managers coordinating tenant improvement work',
        'Projects experiencing delays that need recovery plans',
      ],
      process: [
        'Project scope and contract document review',
        'Schedule framework and milestone setup',
        'Activity sequencing and duration estimation',
        'Critical path identification and baseline lock',
        'Weekly or bi-weekly schedule update delivery',
        'Final as-built schedule at project closeout',
      ],
      gallery: [
        'https://images.pexels.com/photos/3243090/pexels-photo-3243090.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
    ...
    'project-feasibility': {
      ...
      subtitle: 'Feasibility Studies, Site Analysis & Pre-Development Assessment',
      priceRange: 'Custom / Study-Based',
      timeline: '5–15 business days',
      description: 'Before you commit capital, know if the project makes sense. We conduct thorough feasibility studies covering site conditions, zoning, code constraints, cost projections, and market factors — so you make go/no-go decisions with data, not assumptions.',
      heroImage: 'https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
      included: [
        'Site feasibility and due diligence assessment',
        'Zoning and entitlement review',
        'Conceptual cost estimation',
        'Cost-benefit analysis',
        'Market and demand analysis',
        'Environmental and regulatory constraints review',
        'Pro forma modeling and ROI projections',
        'Infrastructure and utility availability assessment',
        'Risk summary and mitigation options',
        'Executive feasibility report with recommendation',
      ],
      idealFor: [
        'Real estate developers evaluating new sites',
        'Investors considering commercial or industrial acquisitions',
        'Property owners exploring redevelopment options',
        'Municipalities planning public infrastructure projects',
        'Companies evaluating new facility construction',
      ],
      process: [
        'Project brief and site information collection',
        'Desktop research and regulatory review',
        'Site visit and field assessment (if applicable)',
        'Financial modeling and cost projection',
        'Draft feasibility report review',
        'Final report delivery with go/no-go recommendation',
      ],
      gallery: [
        'https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
        'https://images.pexels.com/photos/209251/pexels-photo-209251.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
    ...
    'project-risk-management': {
      ...
      subtitle: 'Risk Identification, Mitigation Planning & Contingency Management',
      priceRange: 'Project-Based',
      timeline: 'Ongoing / Phase-Based',
      description: 'Every construction and commercial project carries risk — cost overruns, scope creep, contractor failures, regulatory surprises. We identify, quantify, and build mitigation plans around your project\'s biggest threats so risks stay manageable and your contingency budget stays intact.',
      heroImage: 'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
      included: [
        'Risk identification and register development',
        'Probability and impact scoring',
        'Mitigation and response plan development',
        'Contingency budget analysis',
        'Change order risk review',
        'Contractor and subcontractor risk assessment',
        'Regulatory and permitting risk tracking',
        'Insurance and bonding gap analysis',
        'Risk status reporting and updates',
        'Post-project risk lessons learned documentation',
      ],
      idealFor: [
        'Project owners managing high-value construction',
        'General contractors on complex or fast-track projects',
        'Developers with multiple concurrent projects',
        'Industrial operators managing capital improvement programs',
        'Lenders or investors requiring risk documentation',
      ],
      process: [
        'Project scope and contract review',
        'Stakeholder risk workshop or intake call',
        'Risk register development and scoring',
        'Mitigation plan and contingency recommendations',
        'Ongoing monitoring and risk status updates',
        'Final risk closeout report',
      ],
      gallery: [
        'https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
        'https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
    ...
    'project-budget-management': {
      ...
      subtitle: 'Budget Development, Cost Tracking & Financial Reporting',
      priceRange: 'Project-Based',
      timeline: 'Ongoing / Project Duration',
      description: 'Budget overruns don\'t happen all at once — they happen line by line, invoice by invoice. We build your project budget from the ground up and track every dollar through closeout, giving owners and developers real-time cost visibility and early warnings before overruns become crises.',
      heroImage: 'https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&w=1920&h=800&fit=crop',
      included: [
        'Project budget development and baseline setting',
        'Cost code structure and breakdown',
        'Invoice review and approval coordination',
        'Change order tracking and cost impact analysis',
        'Cash flow forecasting and draw schedule',
        'Budget-to-actual variance reporting',
        'Contingency tracking and management',
        'Owner and lender financial reporting',
        'Subcontractor payment schedule coordination',
        'Final cost report and closeout reconciliation',
      ],
      idealFor: [
        'Owners who need financial oversight without a full-time PM',
        'Developers managing lender reporting requirements',
        'General contractors seeking budget control tools',
        'Investors monitoring construction loan draws',
        'Facility managers with annual capital budgets',
      ],
      process: [
        'Project estimate and contract review',
        'Budget framework and cost code setup',
        'Baseline budget lock and stakeholder approval',
        'Monthly cost tracking and reporting',
        'Change order evaluation and budget updates',
        'Final cost reconciliation at project closeout',
      ],
      gallery: [
        'https://images.pexels.com/photos/590016/pexels-photo-590016.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
        'https://images.pexels.com/photos/669619/pexels-photo-669619.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
