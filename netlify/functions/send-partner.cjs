  ...
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0">
    ...
    <div style="padding:28px">
      ...
      <p style="color:#475569;line-height:1.7">
        Thank you for applying to join the <strong>ProBuild Concierge Partner Network</strong>. We've received your application for <strong>${d.specialty}</strong> and our team will review it within <strong>24 hours</strong>.
      </p>
  ...
  try {
    ...
    if (data.email) {
      messages.push({
        to: data.email,
        from: fromEmail,
        subject: 'Partner Application Received — ProBuild Concierge',
